...
> This project containts the complete SQL code, in Postgresql, to create a clinic's database. Which include the tables patients, treatments, invoices, invoices_items, medical_histories, treatments and treatments_histories.
